	...
	virtual tsl::elm::Element* createUI() override {
		...
		if (PluginRunning && (Shared -> pluginActive)) {
			if (entry_mode == ApmPerformanceMode_Normal) {
				auto *clickableListItem = new tsl::elm::MiniListItem2("IncreaseFPSGuiTestListItem"_tr);
				...
				auto *clickableListItem2 = new tsl::elm::MiniListItem2("DecreaseFPSGuiTestListItem"_tr);
				clickableListItem2->setClickListener([](u64 keys) { 
					if ((keys & HidNpadButton_A) && PluginRunning) {
						if ((Shared -> FPSmode) < 2 && !(Shared -> FPSlocked)) {
							(Shared -> FPSlocked) = 55;
				...
				auto *clickableListItem2 = new tsl::elm::MiniListItem2("ChangeFPSGuiTestListItem"_tr);
				clickableListItem2->setClickListener([](u64 keys) { 
					if ((keys & HidNpadButton_A) && PluginRunning) {
			...
			auto *clickableListItem4 = new tsl::elm::MiniListItem2("DisableFPSGuiTestListItem"_tr);
			...
			auto *clickableListItem5 = new tsl::elm::MiniListItem2("SaveSettingsGuiTestListItem"_tr);
		...
		auto *clickableListItem3 = new tsl::elm::MiniListItem2("AdvancedSettingsGuiTestListItem"_tr);
		clickableListItem3->setClickListener([](u64 keys) { 
			if ((keys & HidNpadButton_A) && PluginRunning) {
		...
		if (SaltySD) {
			auto *clickableListItem6 = new tsl::elm::MiniListItem2("DisplaySettingsGuiTestListItem"_tr, "\uE151");
		...
		std::string jsonStr = R"(
			{
				...
				"Docked1080pDisplayManualSettingsDockedManualGuiOverlayFrame": "Docked 1080p display manual settings",
				...
				"1080pOverclockWizardDockedGuiListItem": "1080p overclock wizard",
