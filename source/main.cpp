		...
		std::string jsonStr = R"(
			{
				...
				"ReportMaxRefreshRateDockedGuiCustomDrawerText": "Reported max refresh rate: %.2f Hz\nConfig ID: %08X",
				...
				"NotAvailableForOledHintDisplayGuiCustomDrawerText": "Not available for Switch OLED\nin handheld mode.",
